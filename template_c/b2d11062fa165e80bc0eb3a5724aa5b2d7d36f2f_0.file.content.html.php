...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a7049a33a06b9_90703307',
...
function content_5a7049a33a06b9_90703307 (Smarty_Internal_Template $_smarty_tpl) {
?>
                      ...
                      <div class="entry__body">
                        <div class="entry__header">
                          ...
                          <h2 class="entry__title">
                            <a href="tpl/single-post.html">Optimal Amount of Rainfall for Plants</a>
                          </h2>
            ...
            <article class="entry post-list">
              ...
              <div class="entry__body post-list__body">
                <div class="entry__header">
                  <a href="#" class="entry__meta-category">business</a>
                  <h2 class="entry__title">
                    <a href="tpl/single-post.html">Your Business Is Talking. Do You Have the Tools to Listen?</a>
                  </h2>
                  <ul class="entry__meta">
                    <li class="entry__meta-author">
                      <i class="ui-author"></i>
            ...
            <article class="entry post-list">
              ...
              <div class="entry__body post-list__body">
                <div class="entry__header">
                  ...
                  <h2 class="entry__title">
                    <a href="tpl/single-post.html">Removing Bitcoin payments from Steam is a smart move by Valve</a>
                  </h2>
                  <ul class="entry__meta">
                    <li class="entry__meta-author">
                      <i class="ui-author"></i>
            ...
            <article class="entry post-list">
              ...
              <div class="entry__body post-list__body">
                <div class="entry__header">
                  ...
                  <h2 class="entry__title">
                    <a href="tpl/single-post.html">This Is the Burberry Bag Every Fashion Girl Wanted 15 Years Ago</a>
                  </h2>
                  <ul class="entry__meta">
                    <li class="entry__meta-author">
                      <i class="ui-author"></i>
                ...
                <article class="entry">
                  ...
                  <div class="entry__body">
                    <div class="entry__header">
                      <a href="#" class="entry__meta-category">science</a>
                      <h2 class="entry__title">
                        <a href="tpl/single-post.html">Synchrotron scanning reveals amphibious ecomorphology in a new clade of bird-like dinosaurs</a>
                      </h2>
                      <ul class="entry__meta">
                        <li class="entry__meta-author">
                          <i class="ui-author"></i>
                ...
                <ul class="post-list-small">
                    ...
                    <article class="post-list-small__entry">
                      <div class="post-list-small__body">
                        <h3 class="post-list-small__entry-title">
                          <a href="tpl/single-post.html">What Indie Beauty Companies Can Teach Entrepreneurs About Scaling</a>
                        </h3>
                        <ul class="entry__meta">
                          <li class="entry__meta-date">
                            <i class="ui-date"></i>
                  ...
                  <li class="post-list-small__item">
                    <article class="post-list-small__entry">
                      <div class="post-list-small__body">
                        <h3 class="post-list-small__entry-title">
                          <a href="tpl/single-post.html">Bill Gates's 5 Favorite Books of 2017</a>
                        </h3>
                        <ul class="entry__meta">
                          <li class="entry__meta-date">
                            <i class="ui-date"></i>
                  ...
                  <li class="post-list-small__item">
                    <article class="post-list-small__entry">
                      <div class="post-list-small__body">
                        <h3 class="post-list-small__entry-title">
                          <a href="tpl/single-post.html">Sheryl Sandberg's 6 Steps to Make Sure Everyone Feels Safe at Work</a>
                        </h3>
                        <ul class="entry__meta">
                          <li class="entry__meta-date">
                            <i class="ui-date"></i>
                  ...
                  <li class="post-list-small__item">
                    <article class="post-list-small__entry">
                      <div class="post-list-small__body">
                        <h3 class="post-list-small__entry-title">
                          <a href="tpl/single-post.html">Elon Musk May Be Sending a Tesla Roadster to Space on a SpaceX Rocket</a>
                        </h3>
                        <ul class="entry__meta">
                          <li class="entry__meta-date">
                            <i class="ui-date"></i>
                  ...
                  <li class="post-list-small__item">
                    <article class="post-list-small__entry">
                      <div class="post-list-small__body">
                        <h3 class="post-list-small__entry-title">
                          <a href="tpl/single-post.html">GoPro Accidentally Left In Path of Lava and Incredible Footage Survives</a>
                        </h3>
                        <ul class="entry__meta">
                          <li class="entry__meta-date">
                            <i class="ui-date"></i>
                  ...
                  <li class="post-list-small__item">
                    <article class="post-list-small__entry">
                      <div class="post-list-small__body">
                        <h3 class="post-list-small__entry-title">
                          <a href="tpl/single-post.html">The One Goal Every Business Should Have, But Almost None Prioritize</a>
                        </h3>
                        <ul class="entry__meta">
                          <li class="entry__meta-date">
                            <i class="ui-date"></i>
              ...
              <div class="col-md-6 mb-40">
                ...
                <article class="entry">
                  ...
                  <div class="entry__body">
                    <div class="entry__header">
                      <h2 class="entry__title">
                        <a href="tpl/single-post.html">To Succeed in 2018, Ecommerce Entrepreneurs Must Focus on This One Change</a>
                      </h2>
                      <ul class="entry__meta">
                        <li class="entry__meta-author">
                          <i class="ui-author"></i>
              ...
              <div class="col-md-6 mb-40">
                ...
                <article class="entry">
                  ...
                  <div class="entry__body">
                    <div class="entry__header">
                      <h2 class="entry__title">
                        <a href="tpl/single-post.html">What hospitals can do to help keep excess opioids out of communities</a>
                      </h2>
                      <ul class="entry__meta">
                        <li class="entry__meta-author">
                          <i class="ui-author"></i>
              ...
              <div class="col-md-6 mb-40">
                ...
                <article class="entry">
                  ...
                  <div class="entry__body">
                    <div class="entry__header">
                      <h2 class="entry__title">
                        <a href="tpl/single-post.html">Phil Taylor: The Power and The Glory</a>
                      </h2>
                      <ul class="entry__meta">
                        <li class="entry__meta-author">
                          <i class="ui-author"></i>
              ...
              <div class="col-md-6 mb-40">
                ...
                <article class="entry">
                  ...
                  <div class="entry__body">
                    <div class="entry__header">
                      <h2 class="entry__title">
                        <a href="tpl/single-post.html">7 Ways Ecommerce Businesses Can Prevent Holiday Fraud</a>
                      </h2>
                      <ul class="entry__meta">
                        <li class="entry__meta-author">
                          <i class="ui-author"></i>
            ...
            <div id="owl-posts" class="owl-carousel owl-theme">
                ...
                <div class="entry__body">
                  <div class="entry__header">
                    <h2 class="entry__title entry__title--sm">
                      <a href="tpl/single-post.html">The Surprising Way This Designer Picked the Next It Colors</a>
                    </h2>
                    <ul class="entry__meta">
                      <li class="entry__meta-date">
                        <i class="ui-date"></i>
              ...
              <article class="entry">
                ...
                <div class="entry__body">
                  <div class="entry__header">
                    <h2 class="entry__title entry__title--sm">
                      <a href="tpl/single-post.html">What Fashion Editors Are Buying for Every Kid on Our Holiday List</a>
                    </h2>
                    <ul class="entry__meta">
                      <li class="entry__meta-date">
                        <i class="ui-date"></i>
              ...
              <article class="entry">
                ...
                <div class="entry__body">
                  <div class="entry__header">
                    <h2 class="entry__title entry__title--sm">
                      <a href="tpl/single-post.html">Why Coach's Cute New Holiday Collab Is Unexpected</a>
                    </h2>
                    <ul class="entry__meta">
                      <li class="entry__meta-date">
                        <i class="ui-date"></i>
                  ...
                  <ul class="post-list-small">
                    ...
                    <li class="post-list-small__item">
                      <article class="post-list-small__entry clearfix">
                        ...
                        <div class="post-list-small__body">
                          <h3 class="post-list-small__entry-title">
                            <a href="tpl/single-post.html">June in Africa: Taxi wars, smarter cities and increased investments</a>
                          </h3>
                          <ul class="entry__meta">
                            <li class="entry__meta-date">
                              <i class="ui-date"></i>
                    ...
                    <li class="post-list-small__item">
                      <article class="post-list-small__entry clearfix">
                        ...
                        <div class="post-list-small__body">
                          <h3 class="post-list-small__entry-title">
                            <a href="tpl/single-post.html">PUBG Desert Map Finally Revealed, Here Are All The Details</a>
                          </h3>
                          <ul class="entry__meta">
                            <li class="entry__meta-date">
                              <i class="ui-date"></i>
          ...
          <div class="widget">
            ...
            <div id="owl-single" class="owl-carousel owl-theme">
              ...
              <article class="entry">
                ...
                <div class="thumb-text-holder">  
                  <h2 class="thumb-entry-title thumb-entry-title--sm">
                    <a href="tpl/single-post.html">Myanmar little monk reading book outside monastery</a>
                  </h2>
                </div>
              </article>
              ...
              <article class="entry">
                ...
                <div class="thumb-text-holder">  
                  <h2 class="thumb-entry-title thumb-entry-title--sm">
                    <a href="tpl/single-post.html">Spectacular display of northern lights illuminates sky</a>
                  </h2>
                </div>
              </article>
            ...
            <ul class="post-list-small">
              <li class="post-list-small__item">
                <article class="post-list-small__entry clearfix">
                  ...
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="tpl/single-post.html">My First Impressions of iPhone X</a>
                    </h3>
                    <ul class="entry__meta">
              ...
              <li class="post-list-small__item">
                <article class="post-list-small__entry clearfix">
                  ...
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="tpl/single-post.html">The Best Laptops for Kids</a>
                    </h3>
                    <ul class="entry__meta">
                      <li class="entry__meta-rating">
                        <i class="ui-star"></i><!--
              ...
              <li class="post-list-small__item">
                <article class="post-list-small__entry clearfix">
                  ...
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="tpl/single-post.html">PS4 Joypads Pre-Orders Start Friday in NYC</a>
                    </h3>
                    <ul class="entry__meta">
                      <li class="entry__meta-rating">
                        <i class="ui-star"></i><!--
              ...
              <li class="post-list-small__item">
                <article class="post-list-small__entry clearfix">
                  ...
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="tpl/single-post.html">Hands on: Parrot AR Drone 2.0 review</a>
                    </h3>
                    <ul class="entry__meta">
                      <li class="entry__meta-rating">
                        <i class="ui-star"></i><!--
