<?php
/* Smarty version 3.1.30, created on 2018-01-31 13:49:35
  from "E:\IT_study\zhiku-v2.0\tpl\right_sidebar.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a71bb5f807bc3_04009020',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '17425242a55ac519b21c94fdb3e0e84161dda24a' => 
    array (
      0 => 'E:\\IT_study\\zhiku-v2.0\\tpl\\right_sidebar.html',
      1 => 1517402883,
      2 => 'file',
    ),
  ),
...
function content_5a71bb5f807bc3_04009020 (Smarty_Internal_Template $_smarty_tpl) {
?>
                  ...
                  <ul class="post-list-small">
                      ...
                      <article class="post-list-small__entry clearfix">
                        ...
                        <div class="post-list-small__body">
                          <h3 class="post-list-small__entry-title">
                            <a href="tpl/single_article/single-post.html">Google is fixing its troubling burger emoji in Android 8.1</a>
                          </h3>
                    ...
                    <li class="post-list-small__item">
                      <article class="post-list-small__entry clearfix">
                        ...
                        <div class="post-list-small__body">
                          <h3 class="post-list-small__entry-title">
                            <a href="tpl/single_article/single-post.html">How Meditation Can Transform Your Business</a>
                          </h3>
                          <ul class="entry__meta">
                            <li class="entry__meta-date">
                              <i class="ui-date"></i>
                    ...
                    <li class="post-list-small__item">
                      <article class="post-list-small__entry clearfix">
                        ...
                        <div class="post-list-small__body">
                          <h3 class="post-list-small__entry-title">
                            <a href="tpl/single_article/single-post.html">June in Africa: Taxi wars, smarter cities and increased investments</a>
                          </h3>
                          <ul class="entry__meta">
                            <li class="entry__meta-date">
                              <i class="ui-date"></i>
                    ...
                    <li class="post-list-small__item">
                      <article class="post-list-small__entry clearfix">
                        ...
                        <div class="post-list-small__body">
                          <h3 class="post-list-small__entry-title">
                            <a href="tpl/single_article/single-post.html">PUBG Desert Map Finally Revealed, Here Are All The Details</a>
                          </h3>
                          <ul class="entry__meta">
                            <li class="entry__meta-date">
                              <i class="ui-date"></i>
...
"><?php echo $_smarty_tpl->tpl_vars['item']->value['title'];?>
            ...
            <?php if ((isset($_smarty_tpl->tpl_vars['__smarty_foreach_foo']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_foo']->value['iteration'] : null) == 3) {?>
                    <?php break 1;?>
                    <?php }?> 
            <?php
}
